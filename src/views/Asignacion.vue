  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <ion-header collapse="condense">
        <ion-toolbar>
          <ion-title size="large">Asignacion</ion-title>
        </ion-toolbar>
      </ion-header>
        ...
        <ion-card>
          ...
          EN VEZ DE USAR ESTO, CREA TUS PROPIAR REGLAS "MEDIA" EN CSS -->
            ...
            <form @submit.prevent="handleSubmit">
              <ion-row>
                <ion-col>
                  <ion-input v-model="form_data.capital" fill="outline" label-placement="floating" label="Codigo"
              ...
              <ion-row>
                <ion-col>
                  <ion-input v-model="form_data.interest_rate" fill="outline" label-placement="floating"
                    label="Apellidos y Nombres" type="number" step="0.001">
                  </ion-input>
                </ion-col>
              </ion-row>
              ...
              <ion-row>
                <ion-col>
                  <ion-input v-model="form_data.period" fill="outline" label-placement="floating" label="Semestre"
                    type="number">
                  </ion-input>
                </ion-col>
...
const PERIOD_TYPE_CONSTS = [
  { value: "years", label: "sem05" },
  { value: "months", label: "sem06" },
  { value: "days", label: "sem07" },
]
const default_form = {
  capital: "",
  interest_rate: "",
